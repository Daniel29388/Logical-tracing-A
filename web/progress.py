...
PIPELINE_STAGES: list[dict[str, str]] = [
    ...
    {"id": "social", "name": "市场情绪", "icon": "💬", "report_key": "sentiment_report"},
...
EVENT_PIPELINE_STAGES: list[dict[str, str]] = [
    {"id": "event", "name": "新闻事件", "icon": "📰", "report_key": "event_report"},
    {"id": "logic", "name": "逻辑提炼", "icon": "🧠", "report_key": "logic_report"},
    {"id": "target", "name": "标的发现", "icon": "🎯", "report_key": "target_report"},
    {"id": "selection", "name": "选股理由", "icon": "🧾", "report_key": "selection_report"},
    {"id": "block", "name": "逻辑板块", "icon": "🧩", "report_key": "block_report"},
    {"id": "tracker", "name": "30日追踪", "icon": "📗", "report_key": "tracker_report"},
    {"id": "technical", "name": "技术面", "icon": "📊", "report_key": "technical_report"},
]

BOARD_BUILD_STAGES: list[dict[str, str]] = [
    {"id": "discovery_prefetch", "name": "候选发现", "icon": "KW", "report_key": "discovery_context"},
    {"id": "event", "name": "新闻事件", "icon": "📰", "report_key": "event_report"},
    {"id": "logic", "name": "逻辑提炼", "icon": "🧠", "report_key": "logic_report"},
    {"id": "target", "name": "标的发现", "icon": "🎯", "report_key": "target_report"},
    {"id": "selection", "name": "选股理由", "icon": "🧾", "report_key": "selection_report"},
    {"id": "block", "name": "逻辑板块", "icon": "🧩", "report_key": "block_report"},
    {"id": "prefetch", "name": "数据抓取", "icon": "DB", "report_key": "tool_context"},
    {"id": "tracker", "name": "30日追踪", "icon": "📗", "report_key": "tracker_report"},
    {"id": "technical", "name": "技术面", "icon": "📊", "report_key": "technical_report"},
]

BOARD_REFRESH_STAGES: list[dict[str, str]] = [
    {"id": "prefetch", "name": "数据抓取", "icon": "DB", "report_key": "tool_context"},
    {"id": "tracker", "name": "30日追踪", "icon": "📗", "report_key": "tracker_report"},
    {"id": "technical", "name": "技术面", "icon": "📊", "report_key": "technical_report"},
]

EVENT_STAGE_IDS = [s["id"] for s in EVENT_PIPELINE_STAGES]
BOARD_BUILD_STAGE_IDS = [s["id"] for s in BOARD_BUILD_STAGES]
BOARD_REFRESH_STAGE_IDS = [s["id"] for s in BOARD_REFRESH_STAGES]
